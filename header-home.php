...
<!-- Bugherd End -->
  ...
  <body <?php body_class(); ?>>
	  <div class="home-hero-menu nav-container" data-sticky-container>
		<div class="nav__inner" data-sticky data-sticky-on="small" data-margin-top="0" data-options="stickTo:top;">
			<header class="bran-med">
				<section class="header-top flex text-green">
				<!-- Top Left Nav -->
					<?php
			...
			<div class="hero-menu-container flex content">
				<img src="<?php the_field('school_logo_white', 'options'); ?>" alt="logo" class="pc-logo-white">
				<img src="<?php the_field('school_logo_green', 'options'); ?>" alt="logo" class="pc-logo-green">
				<?php
					wp_nav_menu( array(
