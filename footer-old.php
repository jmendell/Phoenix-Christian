<footer class="footer-desktop">
	...
	<div class="footer-bottom">
		<div class="footer-bottom__inner-container content-container flex">
			<div class="footer-bottom__campuses flex flex-40">
			...
			<div class="footer-bottom__contact-info flex-30">
			...
			<div class="footer-bottom__updates flex-30">
				...
				<!-- <form class="subscribe-form flex">
					<input type="text" name="email" placeholder="Enter Your Email" class="bran-med">
					<input type="submit" name="submit" value="Submit" placeholder="Submit" class="bran-bold">
				</form> -->
